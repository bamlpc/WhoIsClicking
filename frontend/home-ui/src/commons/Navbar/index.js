    ...
    <>
      <NavbarContainer MediumPageExtendNavbar={MediumPageExtendNavbar}>
        <NavbarHorizontalContainer>
          ...
          <SmallPages>
            <DropdownMenu onClick={() => setSmallPageExtendNavbar((current) => !current)}>
          ...
          <Pages>
            <NavbarLinkContainer>
              <PageDropdownButton
                Click={() => setExtendedAbout((current) => !current)}
                onMouseOver={aboutHandleMouseIn}
                onMouseOut={aboutHandleMouseOut}
              >
                {extendedAbout ? (
                  <PageLinkExtendedButton to="/about">
                    {t('about_page')}
                  </PageLinkExtendedButton>
                ) : (
                  <PageLinkExtendedButton to="/about">
                ...
                <PageVerticalContainer>
                  {hoverAbout && (
                    <>
                      <PageLinkExtended to="/aboutwic">
                        {t('about_project_page')}
                      </PageLinkExtended>
                      <PageLinkExtended to="/aboutus">
                        {t('about_us_page')}
                      </PageLinkExtended>
                      <PageLinkExtended to="/thanksto">
                        {t('thanksto_page')}
                      </PageLinkExtended>
                    </>
                  )}
              ...
              <PageDropdownButton
                Click={() => setExtendedUser((current) => !current)}
                onMouseOver={userHandleMouseIn}
                onMouseOut={userHandleMouseOut}
              >
                {extendedUser ? (
                  <PageLinkExtendedButton to="/user">
                    {t('user_page')}
                  </PageLinkExtendedButton>
                ) : (
                  <PageLinkExtendedButton to="/user">
                ...
                <PageVerticalContainer>
                  {hoverUser && (
                    <>
                      <PageLinkExtended to="/linkscreation">
                        {t('createlinks_page')}
                      </PageLinkExtended>
                      <PageLinkExtended to="/qrgeneration">
                        {t('qr_page')}
                      </PageLinkExtended>
                      <PageLinkExtended to="/generated">
                        {t('generated_page')}
                      </PageLinkExtended>
          ...
          <Buttons>
            {!loggedIn ? (
              <>
                <LinksButton onClick={() => handleSubmit('/login')}>
                  {t('login_button')}
                </LinksButton>
                <LinksButton onClick={() => handleSubmit('register')}>
                  {t('register_button')}
                </LinksButton>
              </>
            ) : (
              <LinksButton onClick={() => handleSubmit('logout')}>
                {t('logout_button')}
              </LinksButton>
            )}
          </Buttons>
        ...
        <MediumNavbarVerticalContainer>
          {MediumPageExtendNavbar && (
            <NavbarVerticalContainer>
              ...
              <NavbarLinkExtended to="/disclaimer">
                {t('disclaimer_page')}
              </NavbarLinkExtended>
            </NavbarVerticalContainer>
          )}
